...
public class ItemBattleaxe extends ItemSword {
	...
	@Override
	public boolean onBlockDestroyed(ItemStack stack, World worldIn, Block blockIn, net.minecraft.util.BlockPos pos,
	...
	public float getStrVsBlock(ItemStack stack, Block block) {
		for (String type : getToolClasses(stack)) {
			if (block.isToolEffective(type, block.getDefaultState())) {
