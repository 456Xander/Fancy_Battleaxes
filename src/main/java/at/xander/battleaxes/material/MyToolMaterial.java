...
public enum MyToolMaterial {
	NICKEL(2, 300, 7.0f, 2.25f, 12, 6.7f),
	SILVER(2, 280, 6.8f, 2.0f, 20, 6.8f),
	TITANIUM(3, 1300, 8.0f, 4.0f, 14, 7.5f),
	RUBY(3, 1280, 9.0f, 4.2f, 15, 8.0f),
	SAPPHIRE(3, 1850, 8.0f, 3.8f, 15, 7.5f),
	AMETHYST(3, 1550, 8.5f, 4.0f, 15, 7.2f);
